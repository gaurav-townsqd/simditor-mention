...
SimditorMention = (function(superClass) {
  ...
  SimditorMention.prototype._init = function() {
    ...
    this.items = [];
    this.editor.keystroke.add('backspace', 'a', (function(_this) {
      return function(e, $node) {
        if ($node.hasClass('simditor-mention')) {
          _this.editor.selection.setRangeBefore($node);
          $node.remove();
        }
        return void 0;
      };
  ...
  SimditorMention.prototype.getMentionText = function() {
    var val;
  ...
  SimditorMention.prototype._bind = function() {
    ...
    this.editor.on('keydown.simditor-mention', $.proxy(this._onKeyDown, this)).on('keyup.simditor-mention', $.proxy(this.onKeyUpEvent, this));
  ...
  SimditorMention.prototype.filterItem = function(val) {
    var $itemEls, e, re, results;
    if (this.popoverEl != null) {
  ...
  SimditorMention.prototype.getTimeoutDelay = function(val) {
    if (val.length <= 1) {
      return 400;
    }
    if (val.length === 2) {
  ...
  SimditorMention.prototype._keyUpTimeout = null;

  SimditorMention.prototype.onKeyUpEvent = function(e) {
    var val;
    ...
    val = this.getMentionText();
    if (this._keyUpTimeout) {
      clearTimeout(this._keyUpTimeout);
    }
    this._keyUpTimeout = setTimeout(((function(_this) {
      return function() {
        return _this.filterItem(val);
      };
    })(this)), this.getTimeoutDelay(val));
    return void 0;
  };
